...
const english: Record<string, string> = {
  ...
  '窗口内每人张数': 'Images per person in window',
  '例如 5h，留空表示不限额': 'e.g. 5h; leave empty for no limit',
  '例如 5，留空表示不限额': 'e.g. 5; leave empty for no limit',
  '滑动窗口按张计数，组内每人独立额度。重试也计张。窗口与张数必须同时填写或同时留空。': 'Sliding window counted in images. Each member has a personal allowance. Retries count. Window and image count must both be set or both left empty.',
  '不限额': 'No limit',
  '张': ' images',
  ...
  '生成张数已达上限': 'Image generation quota exceeded',
  '生成额度的窗口和张数必须同时填写或同时留空': 'Generation window and image count must both be set or both left empty',
  ...
  '生成额度张数必须为 1-1000000 的整数': 'Image quota must be an integer from 1 to 1,000,000',
  ...
  '视频生成秒数已达上限': 'Video generation second quota exceeded',
  '视频额度的窗口和秒数必须同时填写或同时留空': 'Video window and seconds must both be set or both left empty',
  '视频额度秒数必须为 1-1000000 的整数': 'Video quota seconds must be an integer from 1 to 1,000,000',
  ...
  '视频窗口': 'Video window',
  '窗口内每人秒数': 'Seconds per person in window',
  '例如 1d，留空表示不限额': 'e.g. 1d; leave empty for no limit',
  '例如 60，留空表示不限额': 'e.g. 60; leave empty for no limit',
  '视频额度按秒计数，组内每人独立。提交和重试都扣所选时长。窗口与秒数必须同时填写或同时留空。': 'Sliding window counted in video seconds. Each member has a personal allowance. Submit and retry both count. Window and seconds must both be set or both left empty.',
  '图片不限额': 'No image limit',
  '视频不限额': 'No video limit',
  '秒': ' sec',
  '视频秒数': 'Video seconds',
